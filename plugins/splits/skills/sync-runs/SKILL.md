...
2. Call Splits `get_sync_context` for that provider and range. If a connector needs authentication, ask the athlete to connect it. If Splits reports a source conflict, stop without switching providers.
